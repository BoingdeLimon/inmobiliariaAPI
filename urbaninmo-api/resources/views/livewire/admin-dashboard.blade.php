<div x-data="{ sidebarOpen: true }">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="{{ url('/') }}" class="flex ms-2 md:me-24">
                        <img src="{{ asset('img/logo.svg') }}" class="h-8 me-3" alt="Urban Inmo Logo">
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">
                            UrbanInmo Admin Dashboard
                        </span>
                    </a>
                </div>
            </div>
    ...
    <!-- Main Content -->
    <div class="content mt-24 px-4 lg:ml-64 transition-all duration-300" :class="sidebarOpen ? 'ml-64' : 'ml-0'">
        @if($estadoUsuarios)
            @livewire('user-list')
