<div x-data="{ sidebarOpen: true }" class="dark:bg-slate-700">
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="{{ url('/') }}" class="flex ms-2 md:me-24 space-x-2">
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto">
            <ul class="space-y-2 font-medium">
                @if (auth()->user()->role == 'admin')
                    <li class="mt-6">
                        <button wire:click="botonUsuarios"
                ...
                @endif
                <li class="mt-6">
                    <button wire:click="botonRentals"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M10 2a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h6Zm0 12H4v4h6v-4ZM6 4a2 2 0 0 1 2 2H4a2 2 0 0 1 2-2Z" />
                        </svg>
    ...
    <!-- Main Content -->
    <div class="content mt-24 px-4 transition-all duration-300 md:ml-64 dark:bg-slate-800"
        :class="{
            'ml-64': sidebarOpen,
            'ml-0': !sidebarOpen
        }
