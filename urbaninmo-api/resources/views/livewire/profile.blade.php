<div class="bg-gray-200 min-h-screen flex items-center dark:bg-gray-900">
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-[65vw] mx-auto flex gap-4 dark:bg-gray-800">

        <!-- Columna Izquierda: Propiedades -->
        <div class="flex-shrink-0 bg-gray-100 p-4 rounded-lg w-1/4 dark:bg-gray-700">
            <h2 class="text-xl font-semibold mb-4 dark:text-white">Propiedades</h2>
            <ul class="space-y-2">
                <li class="bg-white p-2 rounded-lg shadow-md dark:bg-gray-600 dark:text-white">Casa Altozano</li>
                <li class="bg-white p-2 rounded-lg shadow-md dark:bg-gray-600 dark:text-white">Loft Centro</li>
            </ul>
        ...
        <div class="flex-grow flex flex-col gap-6">
            ...
            <div class="bg-gray-100 p-6 rounded-lg shadow-md dark:bg-gray-700">
                <div class="flex justify-between items-center">
                    <div class="flex items-center ml-5">
                        <!-- Avatar de Flowbite -->
                        <img class="w-32 h-32 rounded-full" src="https://github.com/shadcn.png" alt="@shadcn">
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold dark:text-white">José Alvarado</h3>
                            <p class="text-gray-600 dark:text-gray-300">Alvarado@example.com.mx</p>
                            <p class="text-gray-600 dark:text-gray-300">+52 443 354 7158</p>
                        </div>
                    </div>
                    <!-- Usando el botón de Flowbite -->
            ...
            <div class="bg-gray-100 p-6 rounded-lg shadow-md dark:bg-gray-700">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold dark:text-white">Información de la Propiedad</h3>
                    <!-- Usando el botón de Flowbite -->
                    <button type="button" class="bg-blue-700 hover:bg-blue-800 text-white font-medium rounded-lg text-sm px-5 py-2.5">Editar</button>
                </div>
                ...
                <!-- Amenidades -->
                <div class="mt-4">
                    <h4 class="font-semibold mb-2 dark:text-white">Amenidades</h4>
                ...
                <!-- Fotos -->
                <div class="mt-4">
                    <h4 class="font-semibold mb-2 dark:text-white">Fotos</h4>
